...
public class PhaseTest {
    ...
    public void testOriginalPhases() {
        ...
        assertEquals("1 run(s) of size 7", ORIGINAL_PHASES[3].toString());
        ...
        assertEquals("1 run(s) of size 8", ORIGINAL_PHASES[4].toString());
        ...
        assertEquals("1 run(s) of size 9", ORIGINAL_PHASES[5].toString());
        ...
        assertEquals("2 number set(s) of size 4, 4", ORIGINAL_PHASES[6].toString());
        ...
        assertEquals("1 color set(s) of size 7", ORIGINAL_PHASES[7].toString());
        ...
        assertEquals("2 number set(s) of size 2, 5", ORIGINAL_PHASES[8].toString());
        ...
        assertEquals("2 number set(s) of size 3, 5", ORIGINAL_PHASES[9].toString());
